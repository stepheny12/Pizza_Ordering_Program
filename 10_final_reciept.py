...
def pizza_price_calc(var_pizza):
    if var_pizza == "Pepperoni":
        ...
        price = 14
    elif var_pizza == "Shrimp Deluxe":
        price = 19
    elif var_pizza == "Mega Meat":
        price = 20
    else:
...
all_pizza = ["1.Pepperoni", "2.Hawaiian", "3.Cheesy Garlic", "4.Meat Lover", "5.Beef & Onion",
             "6.Chicken Deluxe", "7.Italian Lover", "8.Margherita", "9.Shrimp Deluxe", "10.Mega Meat"]
...
if discount == 2:
    ...
    print("The total cost of your order is now {}".format(total_cost))
else:
